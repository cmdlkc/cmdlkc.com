/* ==========================================================================
   STUDIO KARBON — AXONOMETRIC LOGO  v2.2  — TUNABLES
   --------------------------------------------------------------------------
   Loaded by logo-torus-v2.2.html. Both files must sit in the same folder.
...
const CONFIG = {
  ...
  dot: {
    ...
    // 5.0 = current. Bigger than v2.1's 3.2 for a reason: below about 4 there
    //       are not enough pixels across the shape for the thin diagonal rays
    //       to resolve, and the whole thing collapses into a fat diamond.
    ...
    // 0.85 = current — nearly as long as the main arms, much finer
    ...
    // 14 = current — fine hairlines, clearly drawn rather than part of the body
    // 24 = so thin they break up into dashes
    diagonalSharpness: 14,
